...
import loginBackground from "../../assets/bg-cadastro.png";
...
const useStyles = makeStyles(theme => ({
	...
	logo: {
		margin: "0 auto",
		width: "50%", // Reduzido para 50% da largura do contêiner
		maxWidth: "300px", // Máximo de 200px de largura
								...
								<Grid container justify="flex-end">
									<Grid item>
										<Link
											...
											to="/login"
											style={{ color: '#333333' }} // Cor cinza escuro
										>
